...
def vary_param(anatomy, variable):
    ...
    char_val_dict = load_dict(f"data/characteristic_value_dictionaries/mynard_vary_mesh_1pconv_synthetic_data_dict_steady")
    scaling_dict = load_dict("data/scaling_dictionaries/mynard_vary_mesh_1pconv_scaling_dict_steady")
    dPs = []
    marker_list = ["o", "v", "d", "*"]
    ref_list = ["4.0E4", "1.0E3", "6.3E4", "2.1E5"]
    ...
    plt.savefig(f"results/unified0D_plus/mesh_refinement_study_1pconv.pdf", bbox_inches='tight', format = "pdf")
    return
