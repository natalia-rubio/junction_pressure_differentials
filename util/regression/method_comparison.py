...
print ("{:<8} {:<10} {:<10} {:<10} {:<10} {:<10} {:<10}".format('Model','Steady (Train)','Steady (Val)','Unsteady (Train)', 'Unsteady (Val)','Unsteady UO (Train)', 'Unsteady UO (Val)'))
...
reg_unsteady_UO, dP_loss_val_unsteady_UO, dP_loss_train_unsteady_UO = train_knn_model_unsteady_UO(anatomy, num_geos_unsteady, seed = 0, hyperparams = hyperparams)
print ("{:<8} {:<10} {:<10} {:<10} {:<10} {:<10} {:<10}".format('KNN',dP_loss_train_steady, dP_loss_val_steady, dP_loss_train_unsteady, dP_loss_val_unsteady, dP_loss_train_unsteady_UO, dP_loss_val_unsteady_UO))
...
reg_unsteady_UO, dP_loss_val_unsteady_UO, dP_loss_train_unsteady_UO = train_dt_model_unsteady_UO(anatomy, num_geos_unsteady, seed = 0, hyperparams = hyperparams)
print ("{:<8} {:<10} {:<10} {:<10} {:<10} {:<10} {:<10}".format('DT',dP_loss_train_steady, dP_loss_val_steady, dP_loss_train_unsteady, dP_loss_val_unsteady, dP_loss_train_unsteady_UO, dP_loss_val_unsteady_UO))
...
reg_unsteady_UO, dP_loss_val_unsteady_UO, dP_loss_train_unsteady_UO = train_lin_reg_model_unsteady_UO(anatomy, num_geos_unsteady, seed = 0, hyperparams = hyperparams)
print ("{:<8} {:<10} {:<10} {:<10} {:<10} {:<10} {:<10}".format('LR',dP_loss_train_steady, dP_loss_val_steady, dP_loss_train_unsteady, dP_loss_val_unsteady, dP_loss_train_unsteady_UO, dP_loss_val_unsteady_UO))
...
reg_unsteady_UO, dP_loss_val_unsteady_UO, dP_loss_train_unsteady_UO = train_svr_model_unsteady_UO(anatomy, num_geos_unsteady, seed = 0, hyperparams = hyperparams)
print ("{:<8} {:<10} {:<10} {:<10} {:<10} {:<10} {:<10}".format('SVR',dP_loss_train_steady, dP_loss_val_steady, dP_loss_train_unsteady, dP_loss_val_unsteady, dP_loss_train_unsteady_UO, dP_loss_val_unsteady_UO))
...
reg_unsteady_UO, dP_loss_val_unsteady_UO, dP_loss_train_unsteady_UO = train_gpr_model_unsteady_UO(anatomy, num_geos_unsteady, seed = 0, hyperparams = hyperparams)
print ("{:<8} {:<10} {:<10} {:<10} {:<10} {:<10} {:<10}".format('GPR',dP_loss_train_steady, dP_loss_val_steady, dP_loss_train_unsteady, dP_loss_val_unsteady, dP_loss_train_unsteady_UO, dP_loss_val_unsteady_UO))
